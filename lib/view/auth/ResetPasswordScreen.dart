                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Enter the email address associated with your assount, and well email you a link to reset your password."
                            .tr,
                        style: TextStyle(
                            fontSize: 16,
                            letterSpacing: 1,
                          ...
                          try {
                            if (_formKey.currentState?.validate() ?? false) {
                              ...
                              if(forgotPassModel.status==200){
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (builder)=>UserOtpSignUpScreen(otpValue: "",countryCode: "", number: '',email: textEditingControllerEmail.text,)));
                              }else{
